...
class WhatsminerAPI:
    ...
    def get_read_only_info(self, access_token: WhatsminerAccessToken, cmd: str, additional_params: dict = None):
        ...
        try:
            ...
            # When the miner is restarting it can return "Power Rate":inf in the \
            #   'summary' json.
            data_str = data_str.replace(":inf,", ":0,")
...
def recv_response(s, timeout=15):
    ...
    if ready[0]:
        ...
        raise Exception(f"Socket response timed out after {timeout}s")
